...
/**
 * Mutant that change a business rule with another business rule.
 *
 * @author Thiago Delgado Pinto
 *
 */
public class ChangeBusinessRuleSpecMutator implements SpecMutator {

	private final Software software;

	public ChangeBusinessRuleSpecMutator(Software s) {
		this.software = s;
	}
	...
	public boolean mutate(UseCase useCase) {
		...
		// Remove a business rule randomly
