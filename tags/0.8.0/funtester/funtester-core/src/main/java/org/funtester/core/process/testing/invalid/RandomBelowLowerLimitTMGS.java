 ...
 * a random value below the lower limit for the selected element (field).
 * 
 * @author Thiago Delgado Pinto
 *
 */
public final class RandomBelowLowerLimitTMGS
	extends AllExceptOneWithValidValuesTMGS {

	public RandomBelowLowerLimitTMGS(
	...
	public String getTestMethodBaseName() {
		return "%s_with_random_value_below_lower_limit";
	}
	...
	public List< AbstractTestMethod > generateTestMethods(
		...
		return generateMethodsForJustTheEditableElementsOfTheTargetUseCase(
				...
				InvalidValueOption.RANDOM_BEFORE_MIN
				);
	}
}